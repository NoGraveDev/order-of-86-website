...
export const orderColors={Flame:'#f58220',Wild:'#388e45',Arcane:'#8746be',Deep:'#287ccc',Radiant:'#f4cd28',Dream:'#ed83b8',Wanderer:'#8746be'};
const groups={
...
8095|Rosestrike|Split|Gray|Pink Eyes|None
5518|Voidstrike|Split|Black|Green Eyes|None
1714|Roseheart|Classic|Brown|Pink Eyes|None
246|Goldburn|Solid|Orange|Black Eyes|None
4042|Roseflame|Classic|Gray|Pink Eyes|None
1053|Deathforge|Zombie|Black|Black Eyes|None`,
Wild:`3449|Stripeheart|Tiger|Brown|Pink Eyes|Poncho
...
9301|Rosegold|Solid|Yellow|Pink Eyes|None
...
Deep:`4165|Pinkgaze|Collie|White|Pink Eyes|Poncho
...
5381|Roseclassic|Classic|Pink|Black Eyes|Tracksuit
...
9183|Whiteheart|Split|White|Pink Eyes|None
...
export const furColors={Gray:'#808080',Black:'#181818',White:'#f5f5f5',Tan:'#c89d69',Brown:'#794b2b',Orange:'#ee791b',Yellow:'#f4cf32',Purple:'#8544b5',Green:'#39864c',Blue:'#367dbb',Beige:'#dfcba9',Pink:'#ed8bb4',Bronze:'#b87936'};
