export const officialWizards={
  ...
  "3417": {
    ...
    "realm": "Violet Highlands",
    "hatColor": "Blue",
    "suggestedName": "Orangeshield the Flame Prophet",
  ...
  "9396": {
    ...
    "realm": "Frosthollow",
    "hatColor": "Yellow",
    "suggestedName": "Tancollar the Diplomatic Light",
  ...
  "9025": {
    ...
    "realm": "Abyssal Reaches",
    "hatColor": "Yellow",
    "suggestedName": "Grayheart the Split Revealer",
    "suggestedStory": "*Gray Split | Red Eyes | None | Abyssal Reaches \u2192 Solar Spire*\n\nFrom the realm of duality and complex perspectives, Grayheart brings Split vision to revelation magic. Their gray base color with subtle split-toning provides perfect neutrality for truth-magic, while their red eyes see oneiroic truth as clearly as factual truth. They specialize in Diplomatic Revelation, showing people uncomfortable truths in ways that promote understanding rather than conflict.\n\nTheir magic focuses on Balanced Truth, revealing both sides of complex situations, showing how apparent contradictions can both be true, and using light magic to illuminate the common ground hidden beneath surface disagreements. Grayheart's Split nature lets them understand multiple perspectives simultaneously, while their red eyes track the oneiroic dynamics that determine whether revealed truth will be accepted or rejected. They serve as the Radiant's specialist in conflict resolution through enlightenment.\n\n---"
  },
  "6203": {
    "fur": "Tan",
    "pattern": "Husky",
  ...
  "9089": {
    ...
    "realm": "Abyssal Reaches",
    "hatColor": "Magenta",
    "suggestedName": "The Warlock",
    "suggestedStory": "*Black Split | Red Eyes | Tracksuit | Ball | Abyssal Reaches \u2192 Dream Spire*\n\nThe rarest Wizard in the Order of 86. The rarest Wizard in the entire Doginal Dogs collection. And they're a Somnambulist. A Black Split from the Abyssal Reaches, the realm of duality and impossible perspectives, wearing a Tracksuit (one of the very few clothed Wizards) and carrying a Ball (unique among all 86). Red eyes in a black face, the rarest eye color combined with the starkest fur contrast.\n\nThe Warlock's incredible rarity translates to raw magical potential that terrifies even experienced Wizards. When they join a pack cast, the multiplicative effect of Dream magic reaches levels that could reshape reality itself. Their Red eyes, the rarest eye color among the Wizards, see dream-threads as physical threads, visible and tangible as rope or wire. Their Split heritage lets them experience multiple oneiroic perspectives simultaneously, while their black fur absorbs and concentrates oneiroic energy from everyone around them.\n\nThe Tracksuit marks them as deliberately casual, rejecting the solemnity that most Wizards affect. The Ball suggests playfulness, youth, or perhaps the wisdom to remember that joy is the highest form of love. Their presence at the Dream Spire makes the entire structure pulse stronger, and their subconscious range, from childlike wonder to cosmic subconscious sight, drives their Order-mates to heights of magical power they never imagined possible. The most powerful entity in the Caninsphere carries a ball and wears a tracksuit. That's not a contradiction, that's the point.\n\n---"
  },
  "2855": {
    "fur": "Brown",
    "pattern": "Solid",
    ...
    "realm": "Sunward Heights",
    "hatColor": "Magenta",
    "suggestedName": "Lensheart the Scholarly Amplifier",
  ...
  "3735": {
    ...
    "realm": "Violet Highlands",
    "hatColor": "Magenta",
    "suggestedName": "Roseheart the Steady Bond",
    "suggestedStory": "*Tan Classic | Black Eyes | Collar | Violet Highlands \u2192 Dream Spire*\n\nThe second Classic in the Dream Order, but where Glassesheart focuses on theory, Tancollar specializes in long-term dream-thread maintenance. Their tan fur provides earth-tone stability for sustained oneiroic magic, while their collar contains memory-threads that preserve important oneiroic moments between bonded individuals.\n\nTheir magic is Relationship Maintenance, strengthening bonds that have weakened over time, helping partners rediscover what they originally loved about each other, and preventing small oneiroic problems from becoming major conflicts. Tancollar's Classic nature provides the patience needed for dream-thread work that might take years to complete. They serve as the Dream's counselor, helping individuals and groups work through oneiroic difficulties that interfere with magical cooperation.\n\n---"
  },
  "6502": {
    "fur": "White",
    "pattern": "Collie",
    ...
    "realm": "Deepwood",
    "hatColor": "Purple",
    "suggestedName": "Sleepyheart the Dream Bonder",
    "suggestedStory": "*Tan Classic | Sleepy Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe third Classic in the Dream Order, specializing in dream-threads that form during sleep and unconscious states. Their tan fur provides neutrality for dream-work, while their permanently sleepy appearance reflects their specialty in unconscious dream-bonding magic. They earned recognition by successfully maintaining pack bonds between Wizards who were too traumatized by the Loyalty Wars to work together while awake.\n\nTheir magic is Dream Bonding, creating oneiroic connections through shared dreams, healing dream-thread trauma while subjects sleep, and maintaining pack cohesion when conscious tensions make cooperation impossible. Sleepyheart spends most of their time in controlled sleep states, working in dream realms where subconscious barriers are lowered and healing can occur more easily. They serve as the Dream's specialist in trauma recovery and unconscious dream healing.\n\n---"
  },
  "4650": {
    "fur": "Tan",
    "pattern": "Solid",
    ...
    "realm": "Sunward Heights",
    "hatColor": "Purple",
    "suggestedName": "Sandstone the Stable Amplifier",
    "suggestedStory": "*Brown Classic | Black Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe fourth Classic in the Dream Order, demonstrating that steady, reliable breeds are naturally suited to dream magic that requires long-term commitment. Brownheart's brown fur provides earth-tone grounding for oneiroic magic, while their black eyes maintain focus on individual dream-threads rather than getting overwhelmed by group dynamics.\n\nTheir magic is Steady Amplification, providing consistent dream support that doesn't fluctuate with circumstances, maintaining stable magical amplification even during crisis periods, and serving as oneiroic anchor for more volatile pack members. Brownheart's reliability makes them the Dream Wizard that others turn to when they need oneiroic stability rather than dramatic magical effects. They serve as the Order's foundation, proving that the most important dream magic is quiet, consistent, and utterly dependable.\n\n---"
  },
  "7439": {
    "fur": "Yellow",
    "pattern": "Solid",
    ...
    "realm": "Sunward Heights",
    "hatColor": "Purple",
    "suggestedName": "Goldsentry the Gentle Endurer",
    "suggestedStory": "*Tan Husky | Sleepy Eyes | None | Frosthollow \u2192 Dream Spire*\n\nA Husky from the harsh arctic realm practicing the magic of gentle oneiroic connection. Sleepyhusky's tan fur provides warmth-tones that contrast with their ice-realm heritage, while their sleepy eyes mask the intense oneiroic endurance that Husky breeds bring to pack work. They earned their magenta hat by maintaining pack bonds during the longest winter in Frosthollow's recorded history, when isolation and darkness threatened to break every social connection in the realm.\n\nTheir magic is Endurance Bonding, oneiroic connections that survive any hardship, pack magic that grows stronger under pressure, and the patient love that outlasts any crisis. Sleepyhusky's Husky heritage provides the oneiroic stamina needed for dream-thread work in the harshest conditions, while their sleepy nature allows them to conserve oneiroic energy for when it's most needed. They serve as the Dream's specialist in crisis dream-bonding, proving that the gentlest magic is sometimes the strongest.\n\n---"
  },
  "6198": {
    "fur": "Gray",
    "pattern": "Tiger",
    ...
    "realm": "Ember Wastes",
    "hatColor": "Purple",
    "suggestedName": "Ashstripe the Veil Ripper",
    "suggestedStory": "*Black Husky | Sleepy Eyes | None | Frosthollow \u2192 Dream Spire*\n\nThe second Husky in the Dream Order, but where Sleepyhusky focuses on endurance, Blackhusky specializes in amplifying the hidden oneiroic strengths that people don't know they possess. Their black fur absorbs and concentrates oneiroic energy, while their sleepy eyes see the dormant potential in damaged or discouraged individuals.\n\nTheir magic is Hidden Strength Amplification, finding the oneiroic resources that people have forgotten they possess, amplifying courage in those who think they're cowards, and revealing the deep love that fear or trauma has concealed. Blackhusky's black fur makes them nearly invisible in oneiroic darkness, allowing them to work with individuals too damaged for conventional healing. They serve as the Dream's specialist in recovering lost oneiroic capacity, proving that no one is ever completely beyond the reach of love.\n\n---"
  },
  "9624": {
    "fur": "Black",
    "pattern": "Spotted",
    ...
    "realm": "Deepwood",
    "hatColor": "Purple",
    "suggestedName": "Inkspot the Silent Decoder",
    "suggestedStory": "*Brown Classic | Black Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe fifth Classic in the Dream Order, demonstrating the natural affinity between steady breeds and consistent oneiroic magic. Brownsteady's brown fur provides perfect grounding for long-term dream-thread work, while their black eyes maintain clear focus on individual oneiroic needs without being distracted by complex group dynamics.\n\nTheir magic is Reliable Love, dream support that never wavers, amplification magic that works the same way every time, and the steady affection that makes long-term pack bonds possible. Brownsteady serves as oneiroic baseline for their pack, providing the consistent love that allows others to take oneiroic risks. They prove that spectacular displays of affection are less important than reliable presence, being the pack member who's always there, always caring, always ready to help.\n\n---"
  },
  "3479": {
    "fur": "Beige",
    "pattern": "Classic",
    ...
    "realm": "Violet Highlands",
    "hatColor": "Magenta",
    "suggestedName": "Dawnheart the Neutral Amplifier",
    "suggestedStory": "*Gray Classic | Black Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe sixth Classic in the Dream Order, specializing in neutral amplification that doesn't favor any particular oneiroic approach. Grayheart's gray fur provides perfect oneiroic neutrality, while their black eyes maintain focus without introducing personal bias into their amplification magic. They serve as the ideal amplifier for mixed groups where different personalities need different types of dream support.\n\nTheir magic is Universal Amplification, enhancing whatever oneiroic strengths each individual brings to the pack, providing amplification that adapts to different personality types, and serving as neutral ground where conflicting oneiroic styles can find harmony. Grayheart's neutrality makes them valuable for diplomatic magic and conflict resolution, proving that sometimes the most loving thing is to amplify others without adding your own oneiroic agenda to the mix.\n\n---"
  },
  "1271": {
    "fur": "White",
    "pattern": "Collie",
    ...
    "realm": "Deepwood",
    "hatColor": "Magenta",
    "suggestedName": "Snowcollie the Patient Amplifier",
    "suggestedStory": "*Tan Classic | Black Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe seventh Classic in the Dream Order, demonstrating that the breed most suited to oneiroic magic is also the most common breed in Pawtheon. Tansteady's tan fur provides earth-tone stability, while their patient nature makes them ideal for dream-work that requires years rather than moments to complete.\n\nTheir magic is Patient Love, dream support that works on long timescales, amplification that builds gradually rather than flaring dramatically, and the understanding that real oneiroic change requires time and consistency. Tansteady works with individuals and dream-threads that need years of support to heal from major trauma. They prove that the most powerful dream magic is often the quietest, working so gradually that its effects are only noticed when looking back over long periods of time.\n\n---"
  },
  "9017": {
    "fur": "Tan",
    "pattern": "Classic",
    ...
    "realm": "Violet Highlands",
    "hatColor": "Magenta",
    "suggestedName": "Sleepysteady the Gentle Dreamer",
    "suggestedStory": "*Gray Classic | Sleepy Eyes | None | Violet Highlands \u2192 Dream Spire*\n\nThe eighth and final Classic in the Dream Order, specializing in gentle dream-work that occurs during rest and sleep. Their gray fur provides neutrality for unconscious dream-work, while their permanently sleepy appearance reflects their specialty in dream-state dream-bonding and healing.\n\nTheir magic is Gentle Dream Healing, dream recovery that happens while sleeping, dream magic that works through shared dreams, and the kind of subtle dream support that heals without the subject realizing they're being healed. Sleepysteady's sleepy nature allows them to work in dream states where subconscious barriers are down and healing can occur without resistance. They serve as the Dream's specialist in unconscious dream support, proving that love works best when it doesn't call attention to itself."
  },
  "6164": {
    "fur": "Gray",
    "pattern": "Solid",
