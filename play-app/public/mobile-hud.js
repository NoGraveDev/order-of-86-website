export function createMobileHUD({pause}){
 ...
 const grid=$('hudMenuGrid'),buttons=['accountBtn','dogsBtn','collectionBtn','buildBtn','achievementsBtn','settingsBtn','helpBtn'].map($),quest=$('quest'),room=$('roomBar'),chat=$('packChat'),homes=new Map();
